...
THREE.extend(THREE.Vector3.prototype, {
    set: function (a, b, c) {
        ...
        var b = this.x, c = this.y, d = this.z, e = a.x, f = a.y, g = a.z, a = a.w, h = a * b + f * d - g * c, i = a * c + g * b - e * d, k = a * d + e * c - f * b, b = -e * b - f * c - g * d;
...
THREE.extend(THREE.Matrix4.prototype, {
    set: function (a, b, c, d, e, f, g, h, i, k, l, m, n, s, r, p) {
        ...
        var c = this.elements,
            d = a.x, e = a.y, f = a.z, g = Math.cos(d), d = Math.sin(d), h = Math.cos(e), e = Math.sin(e), i = Math.cos(f), f = Math.sin(f);
        if (void 0 === b || "XYZ" === b) {
        ...
        var c = a.elements, d = b.elements, e = this.elements, f = c[0], g = c[4], h = c[8], i = c[12], k = c[1], l = c[5], m = c[9], n = c[13], s = c[2], r = c[6], p = c[10], q = c[14], y = c[3], v = c[7], z = c[11], c = c[15], t = d[0], A = d[4], I = d[8], C = d[12], x = d[1], G = d[5], J = d[9],
        ...
        var a = this.elements, b = a[0], c = a[4], d = a[8], e = a[12], f = a[1], g = a[5], h = a[9], i = a[13], k = a[2], l = a[6], m = a[10], n = a[14];
        ...
        var c = this.elements, d = a.elements, e = d[0], f = d[4], g = d[8], h = d[12], i = d[1], k = d[5], l = d[9], m = d[13], n = d[2], s = d[6], r = d[10], p = d[14], q = d[3], y = d[7], v = d[11], z = d[15];
        ...
        var d = a.x, e = a.y, f = a.z, g = Math.sqrt(d * d + e * e + f * f), d = d / g, e = e / g, f = f / g, g = d * d, h = e * e, i = f * f, k = Math.cos(b), l = Math.sin(b), m = 1 - k, n = d * e * m, s = d * f * m, m = e * f * m, d = d * l, r = e * l, l = f * l, f = g + (1 - g) * k, g = n + l, e = s - r, n = n - l, h = h + (1 - h) * k, l = m + d, s = s + r, m = m - d, i = i + (1 - i) * k, k = c[0], d = c[1], r = c[2], p = c[3], q = c[4], y = c[5], v = c[6],
...
THREE.extend(THREE.Frustum.prototype, {
    set: function (a, b, c, d, e, f) {
        ...
        var b = this.planes, c = a.elements, a = c[0], d = c[1], e = c[2], f = c[3], g = c[4], h = c[5], i = c[6], k = c[7], l = c[8], m = c[9], n = c[10], s = c[11], r = c[12], p = c[13], q = c[14], c = c[15];
...
THREE.extend(THREE.Plane.prototype, {
    ...
    coplanarPoint: function (a) {
        ...
        var a = new THREE.Vector3, b = new THREE.Vector3;
        return function (c, d) {
            var d = d || (new THREE.Matrix3).getInverse(c).transpose(), e = a.copy(this.normal).applyMatrix3(d), f = this.coplanarPoint(b);
            f.applyMatrix4(c);
...
THREE.Triangle.barycoordFromPoint = function () {
    ...
    return function (d, e, f, g, h) {
        ...
        b.subVectors(f, e);
        c.subVectors(d, e);
        var d = a.dot(a), e = a.dot(b), f = a.dot(c), i = b.dot(b), g = b.dot(c), k = d * i - e * e, h = h || new THREE.Vector3;
...
THREE.JSONLoader.prototype.loadAjaxJSON = function (a, b, c, d, e) {
    var f = new // Removed for static mirror;
...
THREE.SceneLoader.prototype.parse = function (a, b, c) {
    ...
    function h(a, b, c, d) {
        return function (f) {
            var f = f.content ? f.content : f.dae ? f.scene : f, g = d.position, h = d.rotation, i = d.quaternion, n = d.scale;
...
//  console.log("THREE.CanvasRenderer", THREE.REVISION);
    var k = THREE.Math.smoothstep, a = a || {}, l = this, m, n, s, r = new THREE.Projector, p = void 0 !== a.canvas ? a.canvas : document.createElement("canvas"), q, y, v, z, t = p.getContext("2d"), A = new THREE.Color(0), I = 0, C = 1, x = 0, G = null, J = null, E = null, H = null, B = null, W = null, F = 0, K, L, U, fa, Ca = new THREE.RenderableVertex, $a = new THREE.RenderableVertex, M, ca, qa, ha, ra, N, Ma, Na, mb, Pa, ta, ka, aa = new THREE.Color, pa = new THREE.Color, Y = new THREE.Color, da =
        new THREE.Color, la = new THREE.Color, Z = new THREE.Color, oa = new THREE.Color, gb = new THREE.Color, nb = {}, ia = {}, Wa, ab, Fa, Xa, ub, Ib, Jb, fc, Ab, mc, pb = new THREE.Box2, Ka = new THREE.Box2, Va = new THREE.Box2, gc = !1, vb = new THREE.Color, Qa = new THREE.Color, La = new THREE.Color, bb = new THREE.Vector3, xb, j, yb, Ra, cb, Sa, zb = 16;
    ...
    this.render = function (a, p) {
        ...
        function F(a, b, c, d, e, f, g, j, i, wa, k, l, n) {
            if (!(n instanceof THREE.DataTexture || void 0 === n.image || 0 == n.image.width)) {
                ...
                var m = n.offset.x /
                    n.repeat.x, hb = n.offset.y / n.repeat.y, p = n.image.width * n.repeat.x, q = n.image.height * n.repeat.y, g = (g + m) * p, j = (1 - j + hb) * q, c = c - a, d = d - b, e = e - a, f = f - b, i = (i + m) * p - g, wa = (1 - wa + hb) * q - j, k = (k + m) * p - g, l = (1 - l + hb) * q - j, m = i * l - k * wa;
...
THREE.WebGLRenderer = function (a) {
    ...
    function d(a, b) {
        var c = b.geometry, d = a.faces3, h = a.faces4, i = 3 * d.length + 4 * h.length, k = 1 * d.length + 2 * h.length, h = 3 * d.length + 4 * h.length, d = e(b, a), n = g(d), l = f(d), m = d.vertexColors ? d.vertexColors : !1;
    ...
    var a = a || {}, U = void 0 !== a.canvas ? a.canvas : document.createElement("canvas"),
        fa = void 0 !== a.precision ? a.precision : "highp", Ca = void 0 !== a.alpha ? a.alpha : !0, $a = void 0 !== a.premultipliedAlpha ? a.premultipliedAlpha : !0, M = void 0 !== a.antialias ? a.antialias : !1, ca = void 0 !== a.stencil ? a.stencil : !0, qa = void 0 !== a.preserveDrawingBuffer ? a.preserveDrawingBuffer : !1, ha = void 0 !== a.clearColor ? new THREE.Color(a.clearColor) : new THREE.Color(0), ra = void 0 !== a.clearAlpha ? a.clearAlpha : 0;
    this.domElement = U;
    this.context = null;
    ...
    var gd = j.getParameter(j.MAX_CUBE_MAP_TEXTURE_SIZE), Cc = cb ? j.getParameter(cb.MAX_TEXTURE_MAX_ANISOTROPY_EXT) : 0, sc = 0 < fd, tc = sc && yb;
    Sa && j.getParameter(j.COMPRESSED_TEXTURE_FORMATS);
    var jd = j.getShaderPrecisionFormat(j.VERTEX_SHADER, j.HIGH_FLOAT), kd = j.getShaderPrecisionFormat(j.VERTEX_SHADER, j.MEDIUM_FLOAT);
    j.getShaderPrecisionFormat(j.VERTEX_SHADER, j.LOW_FLOAT);
    var ld =
        j.getShaderPrecisionFormat(j.FRAGMENT_SHADER, j.HIGH_FLOAT), id = j.getShaderPrecisionFormat(j.FRAGMENT_SHADER, j.MEDIUM_FLOAT);
    ...
    this.initWebGLObjects = function (a) {
        ...
        for (; a.__objectsAdded.length;) {
            ...
            if (!b.__webglInit)if (b.__webglInit = !0, b._modelViewMatrix = new THREE.Matrix4, b._normalMatrix = new THREE.Matrix3, void 0 !== b.geometry && void 0 === b.geometry.__webglInit && (b.geometry.__webglInit = !0, b.geometry.addEventListener("dispose", wd)), b instanceof THREE.Mesh)if (m = b.geometry, p = b.material, m instanceof THREE.Geometry) {
                if (void 0 === m.geometryGroups) {
                    var s =
                        m, x = void 0, C = void 0, B = void 0, A = void 0, F = void 0, E = void 0, G = {}, I = s.morphTargets.length, J = s.morphNormals.length, K = p instanceof THREE.MeshFaceMaterial;
                    s.geometryGroups = {};
                    x = 0;
        ...
        for (var oa = 0, ra = a.__webglObjects.length; oa < ra; oa++) {
            ...
            if (ta instanceof THREE.Mesh)if (O instanceof THREE.BufferGeometry)(O.verticesNeedUpdate || O.elementsNeedUpdate || O.uvsNeedUpdate || O.normalsNeedUpdate || O.colorsNeedUpdate || O.tangentsNeedUpdate) && i(O, j.DYNAMIC_DRAW, !O.dynamic), O.verticesNeedUpdate = !1, O.elementsNeedUpdate = !1, O.uvsNeedUpdate = !1, O.normalsNeedUpdate = !1, O.colorsNeedUpdate = !1, O.tangentsNeedUpdate = !1; else {
                for (var Ca = 0, Ka = O.geometryGroupsList.length; Ca < Ka; Ca++)if (mb = O.geometryGroupsList[Ca], ia = e(ta, mb), O.buffersNeedUpdate && d(mb, ta), qa = ia.attributes && y(ia), O.verticesNeedUpdate || O.morphTargetsNeedUpdate || O.elementsNeedUpdate || O.uvsNeedUpdate || O.normalsNeedUpdate || O.colorsNeedUpdate || O.tangentsNeedUpdate || qa) {
                    ...
                    if (sa.__inittedArrays) {
                        var gb = f(Fa), Wa = Fa.vertexColors ? Fa.vertexColors : !1, bb = g(Fa), $a = gb === THREE.SmoothShading, D = void 0, V = void 0, Ra = void 0,
                            ...
                            qd = qb.faceVertexUvs[1], vc = qb.skinIndices, pc = qb.skinWeights, qc = qb.morphTargets, Qc = qb.morphNormals;
                ...
                if (O.verticesNeedUpdate || O.colorsNeedUpdate || O.normalsNeedUpdate || qa) {
                    var Gb = O, Rc = j.DYNAMIC_DRAW, Fc = void 0, Gc = void 0, Hc = void 0, Sc = void 0, za = void 0, Tc = void 0, Uc = void 0, Vc = void 0, xd = void 0, ib = void 0, zc = void 0, Da = void 0, rb = void 0, yd = Gb.vertices, zd = Gb.colors, Ad = Gb.normals, gd = yd.length, hd = zd.length, id = Ad.length, Wc = Gb.__vertexArray, Xc = Gb.__colorArray, Yc = Gb.__normalArray,
                ...
                if (O.verticesNeedUpdate || O.colorsNeedUpdate || O.lineDistancesNeedUpdate || qa) {
                    var Hb = O, Zc = j.DYNAMIC_DRAW, Ic = void 0, Jc = void 0, Kc = void 0, $c = void 0, Ja = void 0, ad = void 0, Bd = Hb.vertices, Cd = Hb.colors, Dd = Hb.lineDistances, ld = Bd.length, Jd = Cd.length, Kd = Dd.length, bd = Hb.__vertexArray, cd = Hb.__colorArray, Ed = Hb.__lineDistanceArray, Ld = Hb.colorsNeedUpdate,
                        Md = Hb.lineDistancesNeedUpdate, sd = Hb.__webglCustomAttributesList, dd = void 0, Fd = void 0, jb = void 0, Ac = void 0, sb = void 0, Ea = void 0;
                ...
                if (O.verticesNeedUpdate || O.colorsNeedUpdate || ta.sortParticles || qa) {
                    var bc = O, td = j.DYNAMIC_DRAW, Lc = ta, tb = void 0, cc = void 0, dc = void 0, ga = void 0, ec = void 0, rc = void 0, ed = bc.vertices, ud = ed.length, vd = bc.colors, Gd = vd.length, wc = bc.__vertexArray, xc = bc.__colorArray, kc = bc.__sortArray, Hd = bc.verticesNeedUpdate, Id = bc.colorsNeedUpdate,
                        lc = bc.__webglCustomAttributesList, Kb = void 0, Bc = void 0, ma = void 0, Lb = void 0, Ba = void 0, ea = void 0;
                    if (Lc.sortParticles) {
                        vb.copy(gc);
...
THREE.ImageUtils = {
    crossOrigin: "anonymous", loadTexture: function (a, b, c, d) {
        ...
        if (a instanceof Array)for (var g = 0, h = a.length; g < h; ++g) {
            ...
            k.send(null)
        } else k = new // Removed for static mirror;
            if (a.isCubemap) {
        ...
        for (var h = h[1] + 4, f = d.width, g = d.height, i = d.isCubemap ?
            ...
            for (var l = 0; l < d.mipmapCount; l++) {
                var m = Math.max(4, f) / 4 * Math.max(4, g) / 4 * e, n = {
        ...
        for (var h = g.getImageData(0,
            ...
            var n = 0 > m - 1 ? 0 : m - 1, s = m + 1 > e - 1 ? e - 1 : m + 1, r = 0 > l - 1 ? 0 : l - 1, p = l + 1 > d - 1 ? d - 1 : l + 1, q = [], y = [0, 0, h[4 * (m * d + l)] / 255 * b];
        ...
        for (k = e - 1; 2 < e;) {
            ...
            a:{
                ...
                if (1E-10 > (p - s) * (v - r) - (q - r) * (y - s))n = !1; else {
                    var A = void 0, I = void 0, C = void 0, x = void 0, G = void 0, J = void 0, E = void 0, H = void 0, B = void 0, W = void 0, B = H = E = t = z = void 0, A = y - p, I = v - q, C = s - y, x = r - v, G = p - s, J = q - r;
...
THREE.CylinderGeometry = function (a, b, c, d, e, f) {
    ...
    for (h = 0; h < d; h++) {
        ...
        for (i = 0; i < e; i++) {
            var s = k[i][h], r = k[i + 1][h], p = k[i + 1][h + 1], q = k[i][h + 1], y = m.clone(), v = m.clone(), z = n.clone(), t = n.clone(), A = l[i][h].clone(), I = l[i + 1][h].clone(), C = l[i + 1][h + 1].clone(), x = l[i][h + 1].clone();
...
THREE.ExtrudeGeometry.prototype.addShape = function (a, b) {
    ...
    function d(a, b, c) {
        var d = THREE.ExtrudeGeometry.__v1, e = THREE.ExtrudeGeometry.__v2, f = THREE.ExtrudeGeometry.__v3, g = THREE.ExtrudeGeometry.__v4, i = THREE.ExtrudeGeometry.__v5, h = THREE.ExtrudeGeometry.__v6;
    ...
    function e(c, d) {
        ...
        for (M = c.length; 0 <= --M;) {
            ...
            for (var g = 0, i = s + 2 * l,
                     g = 0; g < i; g++) {
                var h = fa * g, k = fa * (g + 1), m = d + e + h, h = d + f + h, n = d + f + k, k = d + e + k, p = c, q = g, r = i, t = e, y = f, m = m + H, h = h + H, n = n + H, k = k + H;
...
THREE.ExtrudeGeometry.WorldUVGenerator = {
    generateTopUV: function (a, b, c, d, e, f) {
        ...
        var b = a.vertices[e].x, c = a.vertices[e].y, e = a.vertices[e].z, d = a.vertices[f].x, i = a.vertices[f].y, f = a.vertices[f].z, k = a.vertices[g].x,
...
THREE.SphereGeometry = function (a, b, c, d, e, f, g) {
    ...
    for (c = 0; c < this.heightSegments; c++)for (b = 0; b < this.widthSegments; b++) {
        var d = h[c][b + 1], e = h[c][b], f = h[c + 1][b], g = h[c + 1][b + 1], k = this.vertices[d].clone().normalize(), l = this.vertices[e].clone().normalize(), m = this.vertices[f].clone().normalize(), n = this.vertices[g].clone().normalize(), s = i[c][b + 1].clone(), r = i[c][b].clone(), p = i[c + 1][b].clone(),
            q = i[c + 1][b + 1].clone();
...
THREE.DirectionalLightHelper = function (a, b) {
    ...
    var c = this.color.getHex(), d = new THREE.SphereGeometry(b, 16, 8), e = new THREE.AsteriskGeometry(1.25 * b, 2.25 * b), f = new THREE.MeshBasicMaterial({
        color: c,
        fog: !1
...
THREE.PointLightHelper = function (a, b) {
    ...
    this.color = a.color.clone();
    this.color.multiplyScalar(c);
    var d = this.color.getHex(), c = new THREE.SphereGeometry(b, 16, 8), e = new THREE.AsteriskGeometry(1.25 * b, 2.25 * b), f = new THREE.IcosahedronGeometry(1, 2), g = new THREE.MeshBasicMaterial({
        color: d,
        fog: !1
    }), h = new THREE.LineBasicMaterial({color: d, fog: !1}), d = new THREE.MeshBasicMaterial({
...
THREE.SpotLightHelper = function (a, b) {
    ...
    g.translate(new THREE.Vector3(0,
        -0.5, 0));
    f.applyMatrix(g);
    var h = new THREE.MeshBasicMaterial({color: c, fog: !1}), g = new THREE.LineBasicMaterial({
        color: c,
        fog: !1
...
THREE.LensFlarePlugin = function () {
    ...
    this.render = function (a, d, e, f) {
        ...
        if (v) {
            var z = new THREE.Vector3, t = f / e, A = 0.5 * e, I = 0.5 * f, C = 16 / f, x = new THREE.Vector2(C * t, C), G = new THREE.Vector3(1, 1, 0), J = new THREE.Vector2(1, 1), E = s, C = n;
            b.useProgram(m);
...
THREE.SpritePlugin = function () {
    ...
    this.init = function (a) {
        ...
        b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, h);
        b.bufferData(b.ELEMENT_ARRAY_BUFFER, f, b.STATIC_DRAW);
        var a = THREE.ShaderSprite.sprite, n = b.createProgram(), s = b.createShader(b.FRAGMENT_SHADER), r = b.createShader(b.VERTEX_SHADER), p = "precision " + d + " float;\n";
